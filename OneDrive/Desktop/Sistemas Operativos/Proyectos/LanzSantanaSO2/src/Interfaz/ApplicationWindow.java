...
public class ApplicationWindow extends javax.swing.JFrame {
    ...
    public ApplicationWindow() {
        ...
        starWarsList.setModel(administrator.getStarWarsListModel());
        starTrekList.setModel(administrator.getStarTrekListModel());
    ...
    private void initComponents() {
        ...
        starTrekList = new javax.swing.JList<>();
        jScrollPane2 = new javax.swing.JScrollPane();
        starWarsList = new javax.swing.JList<>();
        ...
        starTrekList.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Item 1", "Item 2", "Item 3", "Item 4", "Item 5" };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
        starTrekList.setName("starTrekList"); // NOI18N
        jScrollPane1.setViewportView(starTrekList);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(910, 560, 249, 93));

        starWarsList.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Item 1", "Item 2", "Item 3", "Item 4", "Item 5" };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
        starWarsList.setName("starWarsList"); // NOI18N
        jScrollPane2.setViewportView(starWarsList);
    ...
    private javax.swing.JList<String> starTrekList;
    private javax.swing.JList<String> starWarsList;
